...
@Component({
  ...
  template: `
    ...
    <div class="flex justify-center py-8 m-8">
      <mat-chip color="green" selected class="flex justify-center py-8" style="width: 50%; border-radius: 10px 100px / 120px;max-width: 250px">Donde encontrarnos?</mat-chip>
      </div>
